...
from architectures.UNET.downsample_2 import Downsample

from architectures.UNET.noise_level_embedding import NoiseLevelEmbedding
...
class UNET_DIFF(nn.Module):
  ...
  def __init__(self,
        device, 
        #1,2,2,4
               img_channels=3,mult=[1,2,2,4],base_channels=64,
        num_res_blocks = 3,
        num_head_channels=-1,
        num_heads=8,
        dropout=0.02,   
